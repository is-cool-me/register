...
### Need help?
- 📚 [Documentation](https://github.com/is-cool-me/register#readme)
- 💬 [Discord Community](https://discord.gg/N8YzrkJxYy)
- 🐛 [Report Issues](https://github.com/is-cool-me/register/issues)
...
Thank you for joining our community! 🚀"""
        ...
        try:
            pr.create_review(event="APPROVE", body="✅ Domain registration approved! Welcome to is-cool.me!")
...
def main():
    ...
    try:
        ...
        print(f"📁 Found {len(domain_files)} domain files to review")
